	...
	private static StandardServiceRegistry rg;
	...
	m.put(Environment.URL,"jdbc:mysql://localhost:3306/servlet1");
	...
	rg=new StandardServiceRegistryBuilder().applySettings(m).build();
