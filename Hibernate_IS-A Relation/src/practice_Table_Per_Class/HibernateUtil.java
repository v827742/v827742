...
public class HibernateUtil {
	...
	public static SessionFactory getsessionFactory()
	{
		if(sf==null)
		{
			...
			m.put(Environment.URL, "jdbc:mysql://localhost:3306/practice_tpc");
			...
			reg=new StandardServiceRegistryBuilder().applySettings(m).build();
			 MetadataSources mds=new MetadataSources(reg);
			    mds.addAnnotatedClass(TwoWheeler.class);
			    mds.addAnnotatedClass(FourWheeler.class);
			    mds.addAnnotatedClass(Vehicle.class);
