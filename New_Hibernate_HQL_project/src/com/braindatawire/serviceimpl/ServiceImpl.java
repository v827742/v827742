...
public class ServiceImpl implements ServiceI{
	...
	String insert="INSERT INTO BackupEmployee(Emp_Id,Emp_name,Emp_Desg,Emp_salary)"+"SELECT Emp_Id,Emp_name,Emp_Desg,Emp_salary FROM Employee";
			Query query=s.createQuery(insert);
		int inserted=query.executeUpdate();
		System.out.println(inserted+"Insert successfully");
		tx.commit();
	}
...
Query<Employee> query=s.createQuery("update Employee set Emp_name=:nm ,Emp_Desg=:deg,"
		+ "Emp_salary=:sal where Emp_Id=:eid");
